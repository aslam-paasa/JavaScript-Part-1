/**
 * Operators:
 * 1. Any programming language can do multiple complex instructions, complex
 *    operations. These complex operations can be as simple as additon or
 *    as complex as calculating powers.
 * 2. Few default operations we get in every programming language and we can
 *    leverage these operations by using the concept of "operators".
 * 3. Operators are pre-defined operations that we can do in the programming
 *    languages.
 * 
