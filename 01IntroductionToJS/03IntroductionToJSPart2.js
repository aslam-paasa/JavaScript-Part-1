/* Introduction to JavaScript :
 ...
 - RAM is a primary storage area or we can say it's a storage device,
   that means if a program is loaded as a process, it gets some memory
   allocated to it from the RAM.
 - Our RAM will have 4 GB memory, so let's say our RAM will allocate
 ...
 - If we run another program and that gets converted to process, that will
...
Q) How to create variables in JS?
 ...
 (a) Using 'var' keyword : var marks = 90;
