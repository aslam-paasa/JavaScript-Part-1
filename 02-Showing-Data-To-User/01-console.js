 ...
 * => In this section, we will cover about: 
 *    (a) console and 
 *    (b) console object methods. 
 * 
 * => Absolute beginners usually do not know which to use: 
 *    (a) console.log(), 
 *    (b) document.write() or document.getElementById.
 * 
 ...
 * => We use document.getElementById() when we like to interact with DOM try using 
